...
INSERT INTO DICTIONARY_CATEGORY(ID, NAME, SYSTEM, ENABLE, BOTIME) VALUES('res.category','物资种类',true,true,'2016-06-1');
INSERT INTO DICTIONARY(ID, CATEGORY, NAME, PRI, ENABLE) VALUES('sg.cp','res.category','砂锅店菜品',1,true);
